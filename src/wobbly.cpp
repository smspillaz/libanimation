...
bool
wobbly::Spring::applyForces (double springConstant)
{
    ...
    mCurrentlyUnequal (false)
{
    ...
    double const tileWidth = mWidth / (gridWidth - 1);
    double const tileHeight = mHeight / (gridHeight - 1);
...
namespace
{
    ...
    unsigned int const StepResolution = 15;
...
wobbly::Model::StepModel (unsigned int time)
{
    ...
    {
        wobbly::ImmediatelyMovablePosition &main = priv->mAnchoredObjects[0];
        ...
        wobbly::Point start;
        bg::assign_point (start,  main.Position ());
