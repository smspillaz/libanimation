    ...
    namespace matchers
    {
            ...
            public t::MatcherInterface <GeometryType const &>
        {
            public:
                ...
                GeometricallyEqualMatcher (GeometryType const &geometry) :
                    mGeometry (geometry)
                {
                }
            ...
            private:
                ...
                GeometryType const &mGeometry;
        };

        template <typename Geometry>
        inline t::Matcher <Geometry const &>
        GeometricallyEqual (Geometry const &geometry)
        {
        ...
        template <typename N>
        inline t::Matcher <typename m::DataModel <N>::Generator>
        SatisfiesModel (typename m::DataModel <N>::Factory const &modelFactory,
